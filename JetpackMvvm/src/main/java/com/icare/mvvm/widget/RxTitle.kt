...
import com.icare.mvvm.util.RxKeyboardUtil
...
class RxTitle : FrameLayout {
    ...
    private fun initView(context: Context, attrs: AttributeSet?) {
        ...
        try {
            ...
            //标题颜色
            mTitleColor = a.getColor(R.styleable.RxTitle_titleColor, Color.parseColor("#333333"))

            //标题字体大小
            mTitleSize = a.getDimensionPixelSize(R.styleable.RxTitle_titleSize, CommonUtil.dp2px(context, 20f))
            ...
            //左边图标
            mLeftIcon = a.getResourceId(R.styleable.RxTitle_leftIcon, R.mipmap.ic_rx_back)
            //右边图标
            mRightIcon = a.getResourceId(R.styleable.RxTitle_rightIcon, R.mipmap.ic_rx_back)
            //左边图标是否显示
    ...
    private fun initAutoFitEditText(context: Context) {
        ...
        mTvTitle?.maxHeight =   CommonUtil.dp2px(context, 55f)
