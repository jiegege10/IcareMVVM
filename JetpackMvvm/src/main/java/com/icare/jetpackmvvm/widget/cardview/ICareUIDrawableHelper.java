...
public class ICareUIDrawableHelper {
    private static final String TAG = ICareUIDrawableHelper.class.getSimpleName();
    ...
    public static Bitmap createBitmapFromView(View view, int leftCrop, int topCrop, int rightCrop, int bottomCrop) {
        Bitmap originBitmap = ICareUIDrawableHelper.createBitmapFromView(view);
