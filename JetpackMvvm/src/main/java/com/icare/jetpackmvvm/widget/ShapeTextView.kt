...
class ShapeTextView @JvmOverloads constructor(
    ...
    defStyleAttr: Int = 0
) : AppCompatTextView(context, attrs, defStyleAttr), IShapeDrawable<ShapeTextView?> {
    ...
    override fun setShape(shape: Int): ShapeTextView {
        mShape = shape
        return this
    }
    ...
    override fun setShapeWidth(width: Int): ShapeTextView {
        mShapeWidth = width
        return this
    }
    ...
    override fun setShapeHeight(height: Int): ShapeTextView {
        mShapeHeight = height
        return this
    }
    ...
    override fun setSolidColor(color: Int): ShapeTextView {
        mSolidColor = color
        return this
    }
    ...
    override fun setTopLeftRadius(radius: Int): ShapeTextView {
    ...
    override fun setTopRightRadius(radius: Int): ShapeTextView {
    ...
    override fun setBottomLeftRadius(radius: Int): ShapeTextView {
    ...
    override fun setBottomRightRadius(radius: Int): ShapeTextView {
    ...
    override fun setStartColor(color: Int): ShapeTextView {
        mStartColor = color
        return this
    }
    ...
    override fun setCenterColor(color: Int): ShapeTextView {
        mCenterColor = color
        return this
    }
    ...
    override fun setEndColor(color: Int): ShapeTextView {
        mEndColor = color
        return this
    }
    ...
    override fun setUseLevel(useLevel: Boolean): ShapeTextView {
        mUseLevel = useLevel
        return this
    }
    ...
    override fun setAngle(angle: Int): ShapeTextView {
        mAngle = angle
        return this
    }
    ...
    override fun setGradientType(type: Int): ShapeTextView {
        mGradientType = type
        return this
    }
    ...
    override fun setCenterX(x: Float): ShapeTextView {
        mCenterX = x
        return this
    }
    ...
    override fun setCenterY(y: Float): ShapeTextView {
        mCenterY = y
        return this
    }
    ...
    override fun setGradientRadius(radius: Int): ShapeTextView {
    ...
    override fun setStrokeColor(color: Int): ShapeTextView {
        mStrokeColor = color
        return this
    }
    ...
    override fun setStrokeWidth(width: Int): ShapeTextView {
        mStrokeWidth = width
        return this
    }
    ...
    override fun setDashWidth(width: Int): ShapeTextView {
        mDashWidth = width
        return this
    }
    ...
    override fun setDashGap(gap: Int): ShapeTextView {
        mDashGap = gap
        return this
    }
