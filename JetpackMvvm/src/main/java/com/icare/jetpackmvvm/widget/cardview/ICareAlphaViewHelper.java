...
public class ICareAlphaViewHelper {
    ...
    public ICareAlphaViewHelper(@NonNull View target) {
        mTarget = new WeakReference<>(target);
        mPressedAlpha = ICareUIResHelper.getAttrFloatValue(target.getContext(), R.attr.icare_alpha_pressed);
        mDisabledAlpha = ICareUIResHelper.getAttrFloatValue(target.getContext(), R.attr.icare_alpha_disabled);
    }

    public ICareAlphaViewHelper(@NonNull View target, float pressedAlpha, float disabledAlpha) {
        mTarget = new WeakReference<>(target);
