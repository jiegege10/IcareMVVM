...
class ShapeConstraintLayout @JvmOverloads constructor(
    ...
    defStyleAttr: Int = 0
) : ConstraintLayout(context, attrs, defStyleAttr), IShapeDrawable<ShapeConstraintLayout?> {
    ...
    override fun setShape(shape: Int): ShapeConstraintLayout {
        mShape = shape
        return this
    }
    ...
    override fun setShapeWidth(width: Int): ShapeConstraintLayout {
        mShapeWidth = width
        return this
    }
    ...
    override fun setShapeHeight(height: Int): ShapeConstraintLayout {
        mShapeHeight = height
        return this
    }
    ...
    override fun setSolidColor(color: Int): ShapeConstraintLayout {
        mSolidColor = color
        return this
    }
    ...
    override fun setTopLeftRadius(radius: Int): ShapeConstraintLayout {
    ...
    override fun setTopRightRadius(radius: Int): ShapeConstraintLayout {
    ...
    override fun setBottomLeftRadius(radius: Int): ShapeConstraintLayout {
    ...
    override fun setBottomRightRadius(radius: Int): ShapeConstraintLayout {
    ...
    override fun setStartColor(color: Int): ShapeConstraintLayout {
        mStartColor = color
        return this
    }
    ...
    override fun setCenterColor(color: Int): ShapeConstraintLayout {
        mCenterColor = color
        return this
    }
    ...
    override fun setEndColor(color: Int): ShapeConstraintLayout {
        mEndColor = color
        return this
    }
    ...
    override fun setUseLevel(useLevel: Boolean): ShapeConstraintLayout {
        mUseLevel = useLevel
        return this
    }
    ...
    override fun setAngle(angle: Int): ShapeConstraintLayout {
        mAngle = angle
        return this
    }
    ...
    override fun setGradientType(type: Int): ShapeConstraintLayout {
        mGradientType = type
        return this
    }
    ...
    override fun setCenterX(x: Float): ShapeConstraintLayout {
        mCenterX = x
        return this
    }
    ...
    override fun setCenterY(y: Float): ShapeConstraintLayout {
        mCenterY = y
        return this
    }
    ...
    override fun setGradientRadius(radius: Int): ShapeConstraintLayout {
    ...
    override fun setStrokeColor(color: Int): ShapeConstraintLayout {
        mStrokeColor = color
        return this
    }
    ...
    override fun setStrokeWidth(width: Int): ShapeConstraintLayout {
        mStrokeWidth = width
        return this
    }
    ...
    override fun setDashWidth(width: Int): ShapeConstraintLayout {
        mDashWidth = width
        return this
    }
    ...
    override fun setDashGap(gap: Int): ShapeConstraintLayout {
        mDashGap = gap
        return this
    }
    ...
    init {
        ...
        mGradientRadius = typedArray.getDimensionPixelSize(
            R.styleable.ShapeConstraintLayout_shape_gradientRadius,
            radius
        )
        mStrokeColor = typedArray.getColor(
            R.styleable.ShapeConstraintLayout_shape_strokeColor,
            IShapeDrawable.DEFAULT_SHAPE_STROKE_COLOR
        )
        mStrokeWidth = typedArray.getDimensionPixelSize(
            R.styleable.ShapeConstraintLayout_shape_strokeWidth,
        ...
        mDashGap = typedArray.getDimension(
            R.styleable.ShapeConstraintLayout_shape_dashGap,
