...
public class ILayout extends FrameLayout {
    ...
    public ILayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            shimmerAngle = a.getInteger(R.styleable.ILayout_i_angle, DEFAULT_ANGLE);
            shimmerAnimationDuration = a.getInteger(R.styleable.ILayout_i_animation_duration, DEFAULT_ANIMATION_DURATION);
            shimmerColor = a.getColor(R.styleable.ILayout_i_color, getColor(R.color.shimmer_color));
            autoStart = a.getBoolean(R.styleable.ILayout_i_auto_start, false);
            maskWidth = a.getFloat(R.styleable.ILayout_i_mask_width, 0.5F);
            gradientCenterColorWidth = a.getFloat(R.styleable.ILayout_i_gradient_center_color_width, 0.1F);
            isAnimationReversed = a.getBoolean(R.styleable.ILayout_i_reverse_animation, false);
        } finally {
            a.recycle();
        }
     ...
     * 1 means the width of the shimmer line is equal to half of the width of the ILayout.
    ...
    /**
     * in ILayout is used ComposeShader, which contains bug in android 4.1.1 with layer hardware acceleration
