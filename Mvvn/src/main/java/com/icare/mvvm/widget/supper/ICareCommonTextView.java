...
* @author: Mr.He
* @param
* @return 通用的textView可以实现大部分常用布局样式
*/

public class ICareCommonTextView extends RelativeLayout {
...
//    private RelativeLayout.LayoutParams rightIVParams;
    ...
    public ICareCommonTextView(Context context) {
        this(context, null);
    }

    public ICareCommonTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ICareCommonTextView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void getAttr(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.ICareCommonTextView);

        ////////设置文字或者图片资源////////
        mLeft_drawableLeft = typedArray.getDrawable(R.styleable.ICareCommonTextView_cLeftIconResForDrawableLeft);
        mLeft_drawableTop = typedArray.getDrawable(R.styleable.ICareCommonTextView_cLeftIconResForDrawableTop);
        mLeft_drawableRight = typedArray.getDrawable(R.styleable.ICareCommonTextView_cLeftIconResForDrawableRight);
        mLeft_drawableBottom = typedArray.getDrawable(R.styleable.ICareCommonTextView_cLeftIconResForDrawableBottom);

        mCenter_drawableLeft = typedArray.getDrawable(R.styleable.ICareCommonTextView_cCenterIconResForDrawableLeft);
        mCenter_drawableTop = typedArray.getDrawable(R.styleable.ICareCommonTextView_cCenterIconResForDrawableTop);
        mCenter_drawableRight = typedArray.getDrawable(R.styleable.ICareCommonTextView_cCenterIconResForDrawableRight);
        mCenter_drawableBottom = typedArray.getDrawable(R.styleable.ICareCommonTextView_cCenterIconResForDrawableBottom);

        mRight_drawableLeft = typedArray.getDrawable(R.styleable.ICareCommonTextView_cRightIconResForDrawableLeft);
        mRight_drawableTop = typedArray.getDrawable(R.styleable.ICareCommonTextView_cRightIconResForDrawableTop);
        mRight_drawableRight = typedArray.getDrawable(R.styleable.ICareCommonTextView_cRightIconResForDrawableRight);
        mRight_drawableBottom = typedArray.getDrawable(R.styleable.ICareCommonTextView_cRightIconResForDrawableBottom);

        mLeft_IV_drawable = typedArray.getDrawable(R.styleable.ICareCommonTextView_cLeftImageViewDrawableRes);
//        mRight_IV_drawable = typedArray.getDrawable(R.styleable.ICareCommonTextView_cRightImageViewDrawableRes);
        /////////////////////

        mLeftTextString = typedArray.getString(R.styleable.ICareCommonTextView_cLeftTextString);
        mLeftTopTextString = typedArray.getString(R.styleable.ICareCommonTextView_cLeftTopTextString);
        mLeftBottomTextString = typedArray.getString(R.styleable.ICareCommonTextView_cLeftBottomTextString);

        mCenterTextString = typedArray.getString(R.styleable.ICareCommonTextView_cCenterTextString);
        mCenterTopTextString = typedArray.getString(R.styleable.ICareCommonTextView_cCenterTopTextString);
        mCenterBottomTextString = typedArray.getString(R.styleable.ICareCommonTextView_cCenterBottomTextString);

        mRightTextString = typedArray.getString(R.styleable.ICareCommonTextView_cRightTextString);
        mRightTopTextString = typedArray.getString(R.styleable.ICareCommonTextView_cRightTopTextString);
        mRightBottomTextString = typedArray.getString(R.styleable.ICareCommonTextView_cRightBottomTextString);

        mLeftTextColor = typedArray.getColor(R.styleable.ICareCommonTextView_cLeftTextColor, defaultColor);
        mLeftTopTextColor = typedArray.getColor(R.styleable.ICareCommonTextView_cLeftTopTextColor, defaultColor);
        mLeftBottomTextColor = typedArray.getColor(R.styleable.ICareCommonTextView_cLeftBottomTextColor, defaultColor);

        mCenterTextColor = typedArray.getColor(R.styleable.ICareCommonTextView_cCenterTextColor, defaultColor);
        mCenterTopTextColor = typedArray.getColor(R.styleable.ICareCommonTextView_cCenterTopTextColor, defaultColor);
        mCenterBottomTextColor = typedArray.getColor(R.styleable.ICareCommonTextView_cCenterBottomTextColor, defaultColor);

        mRightTextColor = typedArray.getColor(R.styleable.ICareCommonTextView_cRightTextColor, defaultColor);
        mRightTopTextColor = typedArray.getColor(R.styleable.ICareCommonTextView_cRightTopTextColor, defaultColor);
        mRightBottomTextColor = typedArray.getColor(R.styleable.ICareCommonTextView_cRightBottomTextColor, defaultColor);

        mLeftTextSize = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cLeftTextSize, defaultSize);
        mLeftTopTextSize = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cLeftTopTextSize, defaultSize);
        mLeftBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cLeftBottomTextSize, defaultSize);

        mCenterTextSize = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cCenterTextSize, defaultSize);
        mCenterTopTextSize = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cCenterTopTextSize, defaultSize);
        mCenterBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cCenterBottomTextSize, defaultSize);

        mRightTextSize = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cRightTextSize, defaultSize);
        mRightTopTextSize = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cRightTopTextSize, defaultSize);
        mRightBottomTextSize = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cRightBottomTextSize, defaultSize);

        mLeftIconDrawablePadding = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cLeftIconDrawablePadding, defaultPadding);
        mCenterIconDrawablePadding = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cCenterIconDrawablePadding, defaultPadding);
        mRightIconDrawablePadding = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cRightIconDrawablePadding, defaultPadding);

        mLeftViewPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cLeftViewPaddingLeft, defaultPadding);
        mLeftViewPaddingRight = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cLeftViewPaddingRight, defaultPadding);
        mCenterViewPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cCenterViewPaddingLeft, defaultPadding);
        mCenterViewPaddingRight = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cCenterViewPaddingRight, defaultPadding);
        mRightViewPaddingLeft = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cRightViewPaddingLeft, defaultPadding);
        mRightViewPaddingRight = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cRightViewPaddingRight, defaultPadding);

        mBothDividerLineMarginLeft = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cBothDividerLineMarginLeft, 0);
        mBothDividerLineMarginRight = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cBothDividerLineMarginRight, 0);

        mTopDividerLineMarginLR = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cTopDividerLineMarginLR, 0);
        mTopDividerLineMarginLeft = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cTopDividerLineMarginLeft, 0);
        mTopDividerLineMarginRight = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cTopDividerLineMarginRight, 0);

        mBottomDividerLineMarginLR = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cBottomDividerLineMarginLR, 0);
        mBottomDividerLineMarginLeft = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cBottomDividerLineMarginLeft, 0);
        mBottomDividerLineMarginRight = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cBottomDividerLineMarginRight, 0);

        mLeftImageViewMarginLeft = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cLeftImageViewMarginLeft, defaultPadding);
//        mRightImageViewMarginRight = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cRightImageViewMarginRight, defaultPadding);

        mCenterSpaceHeight = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cCenterSpaceHeight, mCenterSpaceHeight);


        mLeftTextViewLineSpacingExtra = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cLeftTextViewLineSpacingExtra, 0);
        mCenterTextViewLineSpacingExtra = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cCenterTextViewLineSpacingExtra, 0);
        mRightTextViewLineSpacingExtra = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cRightTextViewLineSpacingExtra, 0);

        mDividerLineType = typedArray.getInt(R.styleable.ICareCommonTextView_cShowDividerLineType, DEFAULT);
        mDividerLineColor = typedArray.getColor(R.styleable.ICareCommonTextView_cDividerLineColor, defaultDividerLineColor);

        mDividerLineHeight = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cDividerLineHeight, dip2px(mContext, 0.5f));

        useRipple = typedArray.getBoolean(R.styleable.ICareCommonTextView_cUseRipple, false);

        mBackgroundColor = typedArray.getColor(R.styleable.ICareCommonTextView_cBackgroundColor, mBackgroundColor);

        mSetSingleLine = typedArray.getBoolean(R.styleable.ICareCommonTextView_cSetSingleLine, true);
        mSetMaxEms = typedArray.getInt(R.styleable.ICareCommonTextView_cSetMaxEms, mSetMaxEms);
        mSetLines = typedArray.getInt(R.styleable.ICareCommonTextView_cSetLines, 1);

        mLeftTextViewGravity = typedArray.getInt(R.styleable.ICareCommonTextView_cLeftTextViewGravity, DEFAULT_Gravity);
        mCenterTextViewGravity = typedArray.getInt(R.styleable.ICareCommonTextView_cCenterTextViewGravity, DEFAULT_Gravity);
        mRightTextViewGravity = typedArray.getInt(R.styleable.ICareCommonTextView_cRightTextViewGravity, DEFAULT_Gravity);

        mLeftViewIsClickable = typedArray.getBoolean(R.styleable.ICareCommonTextView_cLeftViewIsClickable, false);
        mCenterViewIsClickable = typedArray.getBoolean(R.styleable.ICareCommonTextView_cCenterViewIsClickable, false);
        mRightViewIsClickable = typedArray.getBoolean(R.styleable.ICareCommonTextView_cRightViewIsClickable, false);

        mBackground_drawable = typedArray.getDrawable(R.styleable.ICareCommonTextView_cBackgroundDrawableRes);

        mIsCenterAlignLeft = typedArray.getBoolean(R.styleable.ICareCommonTextView_cIsCenterAlignLeft, false);
        mCenterViewMarginLeft = typedArray.getDimensionPixelSize(R.styleable.ICareCommonTextView_cCenterViewMarginLeft, dip2px(mContext, 200));
...
//        }
    ...
    /**
     * 初始化ICareCommonTextView
     */
    private void initICareCommonTextView() {
...
//            textView.setEllipsize(TextUtils.TruncateAt.END);
     ...
     * @return 返回
     */
    public ICareCommonTextView setLeftTextString(CharSequence string) {
        if (leftTextView == null) {
            initLeftText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setLeftTopTextString(CharSequence string) {
        if (leftTopTextView == null) {
            initLeftTopText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setLeftBottomTextString(CharSequence string) {
        if (leftBottomTextView == null) {
            initLeftBottomText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setLeftTextSize(float size) {
        if (leftTextView == null) {
            initLeftText();
        }
     ...
     * @return return
     */
    public ICareCommonTextView setLeftTextColor(int color) {
        if (leftTextView == null) {
            initLeftText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setCenterTextString(CharSequence string) {
        if (centerTextView == null) {
            initCenterText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setCenterTopTextString(CharSequence string) {
        if (centerTopTextView == null) {
            initCenterTopText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setCenterBottomTextString(CharSequence string) {
        if (centerBottomTextView == null) {
            initCenterBottomText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setCenterTextSize(float size) {
        if (centerTextView == null) {
            initCenterText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setCenterTextColor(int color) {
        if (centerTextView == null) {
            initCenterText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setRightTextString(CharSequence string) {
        if (rightTextView == null) {
            initRightText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setRightTopTextString(CharSequence string) {
        if (rightTopTextView == null) {
            initRightTopText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setRightBottomTextString(CharSequence string) {
        if (rightBottomTextView == null) {
            initRightBottomText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setRightTextSize(float size) {
        if (rightTextView == null) {
            initRightText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setRightTextColor(int color) {
        if (rightTextView == null) {
            initRightText();
        }
     ...
     * @return 返回
     */
    public ICareCommonTextView setLeftDrawableLeft(Drawable drawableLeft) {
     ...
     * @returnTop 返回
     */
    public ICareCommonTextView setLeftDrawableTop(Drawable drawableTop) {
        if (drawableTop != null) {
     ...
     * @return 返回
     */
    public ICareCommonTextView setLeftDrawableRight(Drawable drawableRight) {
     ...
     * @return 返回
     */
    public ICareCommonTextView setLeftDrawableBottom(Drawable drawableBottom) {
     ...
     * @return 返回
     */
    public ICareCommonTextView setCenterDrawableLeft(Drawable drawableLeft) {
        if (drawableLeft != null) {
            drawableLeft.setBounds(0, 0, drawableLeft.getMinimumWidth(), drawableLeft.getMinimumHeight());
        }
        if (centerTextView == null) {
     ...
     * @returnTop 返回
     */
    public ICareCommonTextView setCenterDrawableTop(Drawable drawableTop) {
        if (drawableTop != null) {
            drawableTop.setBounds(0, 0, drawableTop.getMinimumWidth(), drawableTop.getMinimumHeight());
        }
        if (centerTextView == null) {
     ...
     * @return 返回
     */
    public ICareCommonTextView setCenterDrawableRight(Drawable drawableRight) {
        if (drawableRight != null) {
            drawableRight.setBounds(0, 0, drawableRight.getMinimumWidth(), drawableRight.getMinimumHeight());
        }
        if (centerTextView == null) {
     ...
     * @return 返回
     */
    public ICareCommonTextView setCenterDrawableBottom(Drawable drawableBottom) {
        if (drawableBottom != null) {
            drawableBottom.setBounds(0, 0, drawableBottom.getMinimumWidth(), drawableBottom.getMinimumHeight());
        }
        if (centerTextView == null) {
     ...
     * @return 返回
     */
    public ICareCommonTextView setRightDrawableLeft(Drawable drawableLeft) {
        if (drawableLeft != null) {
            drawableLeft.setBounds(0, 0, drawableLeft.getMinimumWidth(), drawableLeft.getMinimumHeight());
        }
        if (rightTextView == null) {
     ...
     * @returnTop 返回
     */
    public ICareCommonTextView setRightDrawableTop(Drawable drawableTop) {
        if (drawableTop != null) {
            drawableTop.setBounds(0, 0, drawableTop.getMinimumWidth(), drawableTop.getMinimumHeight());
        }
        if (rightTextView == null) {
     ...
     * @return 返回
     */
    public ICareCommonTextView setRightDrawableRight(Drawable drawableRight) {
        if (drawableRight != null) {
            drawableRight.setBounds(0, 0, drawableRight.getMinimumWidth(), drawableRight.getMinimumHeight());
        }
        if (rightTextView == null) {
     ...
     * @return 返回
     */
    public ICareCommonTextView setRightDrawableBottom(Drawable drawableBottom) {
        if (drawableBottom != null) {
            drawableBottom.setBounds(0, 0, drawableBottom.getMinimumWidth(), drawableBottom.getMinimumHeight());
        }
        if (rightTextView == null) {
     ...
     * @return 返回当前对象便于链式操作
     */
    public ICareCommonTextView setOnCommonTextViewClickListener(OnCommonTextViewClickListener listener) {
     ...
     * @return 返回
     */
    public ICareCommonTextView setLeftViewIsClickable(boolean isClickable) {
        if (isClickable) {
            if (leftTextView != null) {
                leftTextView.setOnClickListener(new OnClickListener() {
                    @Override
     ...
     * @return 返回
     */
    public ICareCommonTextView setCenterViewIsClickable(boolean isClickable) {
        if (isClickable) {
            if (centerTextView != null) {
                centerTextView.setOnClickListener(new OnClickListener() {
                    @Override
     ...
     * @return 返回
     */
    public ICareCommonTextView setRightViewIsClickable(boolean isClickable) {
        if (isClickable) {
            if (rightTextView != null) {
                rightTextView.setOnClickListener(new OnClickListener() {
                    @Override
