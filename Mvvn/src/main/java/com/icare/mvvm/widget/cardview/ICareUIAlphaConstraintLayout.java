...
public class ICareUIAlphaConstraintLayout extends ConstraintLayout implements QMUIAlphaViewInf {
    ...
    public ICareUIAlphaConstraintLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ICareUIAlphaConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
